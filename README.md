...
<img alt="Export with burned‑in captions" src="docs/images/export-with-burned-in-captions.png" width="330">
...
<img alt="Flexible export options" src="docs/images/flexible-export.png" width="330"> <img alt="Export and download menu" src="docs/images/export-and-download.png" width="500">
